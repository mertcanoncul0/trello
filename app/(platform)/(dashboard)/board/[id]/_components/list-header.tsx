...
const ListHeader = ({ data, onAddCard }: ListHeaderProps) => {
    ...
    const onSubmit = (formData: FormData) => {
        const {title, boardId, id} = Object.fromEntries(formData) as {id: string, title: string, boardId: string};
    ...
    const onKeyDown = (e: KeyboardEvent) => e.key === "Escape" && formRef.current?.requestSubmit();
